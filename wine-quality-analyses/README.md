...
A strong focus is placed on model interpretability, combining statistical significance, feature effects, and local partial derivatives to understand both global and context-dependent relationships. Results show that moderately complex non-linear models achieve the best balance between performance and robustness while preserving interpretability.
